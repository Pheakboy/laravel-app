<x-layout>
    <x-slot name="title">Create Chirp</x-slot>
    ...
    <div class="max-w-2xl mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
            <h1 class="text-2xl font-bold text-gray-900 mb-6">Create New Chirp</h1>

            <form action="{{ route('chirps.store') }}" method="POST" class="space-y-6">
                @csrf
